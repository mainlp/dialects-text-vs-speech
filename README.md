...
- `xsid-audio`: Contains the mapping of all xSID dev/test sentences (CC BY-SA 4.0) to intents and to the audio files in https://zenodo.org/records/19554427. This fixes an issue with misaligned German/Bavarian sentences (and Bavarian sentences/audios) in the metadata files included in release 0.1 of the dataset. This issue does not affect our experiments, and it is fixed in release 0.2.
